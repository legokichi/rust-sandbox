...
impl<E: Environment> MonteCarloAgent<E> {
    ...
    fn learn(&mut self, env: &mut E, episode_count: usize, gamma: f64) -> f64
    where
...
impl<E: Environment> QLearningAgent<E> {
    ...
    fn learn(&mut self, env: &mut E, episode_count: usize, gamma: f64, learning_rate: f64) -> f64
    where
        Self: QAgent<Environment = E>,
    {
        let mut total_rewards: Vec<f64> = vec![];
...
fn main() {
    ...
    for epsilon in vec![/*0.0,*/ 0.1, /*1.0*/] {
        ...
        let total_reward = agent.learn(&mut field, episode_count, gamma);
    ...
    for epsilon in vec![/*0.0,*/ 0.1, /*1.0*/] {
        ...
        let total_reward = qagent.learn(&mut field, episode_count, gamma, 0.1);
        println!("total_reward: {}", total_reward);
