...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let stars = vec![
        ...
        ("3", ((3, 0, 0.0), (1, 0, 0, 0.0)), 2.0),
        // ("6", ((6, 0, 0.0), (1, 0, 0, 0.0)), 3.0),
        ("9", ((9, 0, 0.0), (1, 0, 0, 0.0)), 2.0),
        ("12", ((12, 0, 0.0), (1, 0, 0, 0.0)), 2.0),
        ("15", ((15, 0, 0.0), (1, 0, 0, 0.0)), 2.0),
        ("18", ((18, 0, 0.0), (1, 0, 0, 0.0)), 2.0),
        ("21", ((21, 0, 0.0), (1, 0, 0, 0.0)), 2.0),
        ("24", ((24, 0, 0.0), (1, 0, 0, 0.0)), 2.0),
        ("90", ((12, 0, 0.0), (1, 90, 0, 0.0)), 2.0),
        ("75", ((12, 0, 0.0), (1, 75, 0, 0.0)), 2.0),
        // ("60", ((12, 0, 0.0), (1, 60, 0, 0.0)), 3.0),
        ("45", ((12, 0, 0.0), (1, 45, 0, 0.0)), 2.0),
        ("30", ((12, 0, 0.0), (1, 30, 0, 0.0)), 2.0),
        // ("15", ((12, 0, 0.0), (1, 15, 0, 0.0)), 3.0),
        ("-15", ((12, 0, 0.0), (-1, 15, 0, 0.0)), 2.0),
        ("-30", ((12, 0, 0.0), (-1, 30, 0, 0.0)), 2.0),
        ("-45", ((12, 0, 0.0), (-1, 45, 0, 0.0)), 2.0),
        // ("-60", ((12, 0, 0.0), (-1, 60, 0, 0.0)), 3.0),
        ("-75", ((12, 0, 0.0), (-1, 75, 0, 0.0)), 2.0),
    ...
    for i in 0..4 {
        chart.draw_series(LineSeries::new(
            (-240_i64..=0).map(|x| {
                ...
                (
                    x,
                    Delta::from((1, 90-36, 0, 0.0)).to_degree()
                        * ((x / 24_f64) * (std::f64::consts::PI * 2_f64)
                            - (i as f64*std::f64::consts::PI / 2_f64)
                        )
                        .sin(),
                )
            }),
