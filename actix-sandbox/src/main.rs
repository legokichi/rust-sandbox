...
fn main() {
    ...
    actix_web::server::new(||{
        ...
        app = app
            ...
            /*.middleware(ErrorHandlers::new().handler(http::StatusCode::INTERNAL_SERVER_ERROR, |req, res| {
                //let mut builder = res.into_builder();
                //builder.header(http::header::CONTENT_TYPE, "application/json");
                //builder.body("{\"message\":\"error!\"}");
        ...
        }
        {
            ...
            #[derive(Serialize, Deserialize, Debug, Clone)]
            pub struct Response { message: String }
            app = app.route("/err", Method::GET, move |(path, query): (Path<PathParameters>, Query<QueryStringParameters>)|-> FutureResponse<HttpResponse> {
