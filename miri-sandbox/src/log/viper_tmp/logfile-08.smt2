...
; ------------------------------------------------------------
; ---------- m_main$$main$opensqu$0$closesqu$ ----------
(declare-const _0@0@08 $Ref)
(declare-const _0@1@08 $Ref)
(push) ; 1
...
(assert (= $t@4@08 $Snap.unit))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
; inhale true
(declare-const $t@5@08 $Snap)
(assert (= $t@5@08 $Snap.unit))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
