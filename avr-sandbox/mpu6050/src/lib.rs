    ...
    Delay: DelayMs<u16>,
{
    ...
    pub fn set_sleep_enabled(&mut self, enabled: bool) -> Result<(), ()> {
        self.i2c
            .write_bit(self.dev_addr, RA_PWR_MGMT_1, PWR1_SLEEP_BIT, enabled)
    }
    ...
    fn set_memory_start_address(&mut self, address: u8) -> Result<(), ()> {
        self.i2c
            .write_byte(self.dev_addr, RA_MEM_START_ADDR, address)
    }
    ...
    fn set_slave_address(&mut self, num: u8, address: u8) -> Result<(), ()> {
        ...
        self.i2c
            .write_byte(self.dev_addr, RA_I2C_SLV0_ADDR + num * 3, address)
    }
    ...
    pub fn reset(&mut self) -> Result<(), ()> {
        self.i2c
            .write_bit(self.dev_addr, RA_PWR_MGMT_1, PWR1_DEVICE_RESET_BIT, true)
    }
